...
fibonacci="""
00 read r1         #get num
01 jeqzn r1 23     #if num is 0, stop
02 setn r2 0       #set r2 to 0
03 setn r3 1       #set r3 to 1
04 write r2        #print r2 (0, first num of sequence)
05 addn r1 -1      #subtract 1 from num
06 jeqzn r1 23     #if num is 0, stop 
07 write r3        #print r3 (1, second num of sequence)
08 addn r1 -1      #subtract 1 from num
09 jeqzn r1 23     #if num is 0, stop
10 add r4 r2 r3    #set r4 to r3+r2
11 write r4        #print r4 (next num in sequence)
12 addn r1 -1      #subtract 1 from num
13 jeqzn r1 23     #if num is 0, stop
14 copy r5 r4      #set r5 to whats in r4     ###start of loop 
15 add r4 r4 r3    #add r3 to r4
16 write r4        #print r4
17 addn r1 -1      #subtract 1 from num
18 jeqzn r1 23     #if num is 0, stop
19 copy r3 r4      #set r3 to whats in r4
20 add r4 r4 r5    #add r5 to r4 
21 write r4        #print r4
22 addn r1 -1      #subtract 1 from num
23 jeqzn r1 23     #if num is 0, stop
24 jumpn 14        #loop back to line 14      ###end of loop
25 halt            #stop
"""
