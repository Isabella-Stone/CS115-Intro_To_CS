...
class Car(object):
    ...
    def set_mpg(self, flo):
        self.__mpg = flo

    def set_tank_capacity(self, flo):
        self.__tank_capacity = flo
...
class HybridCar():  
    ...
    def get_battery_range(self):
        ...
        battery.
        '''
        return battery_kWh * miles_per_kWh
    ...
    '''
    def get_total_range(self):
        return get_battery_range(self) + Car.get_total_range(self)
